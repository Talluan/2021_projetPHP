...
class VueEditerListe
{
    ...
    {   
        ...
        $old_description = $this->model->description;
        $old_expiration = $this->model->expiration;
        $res = '
        <div class="container">
        ...
        <div class="row">
          ...
          <div class="form-group">
            ...
            <input id="descriptionListe" type="text" name="nom" class="form-control" value="'.$old_description.'">
          </div>
        </div>
        <hr>
