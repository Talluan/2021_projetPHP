...
INSERT INTO `liste` (`no`, `user_id`, `titre`, `description`, `expiration`,`public`, `tokenEdition`) VALUES
(1,	1,	'Pour fêter le bac !',	'Pour un week-end à Nancy qui nous fera oublier les épreuves. ',	'2018-06-27',TRUE,	'nosecure1'),
(2,	2,	'Liste de mariage d\'Alice et Bob',	'Nous souhaitons passer un week-end royal à Nancy pour notre lune de miel :)',	'2018-06-30',TRUE,	'nosecure2'),
(3,	3,	'C\'est l\'anniversaire de Charlie',	'Pour lui préparer une fête dont il se souviendra :)',	'2017-12-12',TRUE,	'nosecure3');
